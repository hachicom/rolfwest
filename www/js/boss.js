...
var BossKilled = Class.create(Sprite, {
  ...
  initialize: function(x,y,enemy) {
    // Call superclass constructor
    Sprite.apply(this,[64, 64]);
    this.image  = Game.instance.assets['res/madbatSheet.png']; //Create a new sheet with all bosses defeated
    this.x = x;
    this.y = y;
    this.id = enemy;
  ...
  createBoss: function() {
    ...
    switch(this.world){
      ...
      // case 2: 
        ...
        // break;
      // case 3: 
        // var boss = new BarthoBoss(game.width/2 - 32,this.y,this.world);
        // break;
      case 4: 
        var boss = new MadBatBoss(game.width/2 - 32,this.y,this.world);
        break;
